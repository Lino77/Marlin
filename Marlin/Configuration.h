...
#define STRING_CONFIG_H_AUTHOR "(lino, BTT MK3s)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "BTT MK3s"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // BTT002 MK3S
  #define DEFAULT_bedKp 42.04
  #define DEFAULT_bedKi 2.26
  #define DEFAULT_bedKd 520.15
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 1650 }
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 60, 240 } // ...or, set your own edit limits
#endif
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 5, -1.20 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 23 //X_CENTER  // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT  5 //Y_CENTER  // Y point for Z homing when homing all axes (G28).
#endif
